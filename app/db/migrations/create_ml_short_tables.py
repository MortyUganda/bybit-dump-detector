...
# asyncpg не умеет multi-statement в одном prepared statement (ProgrammingError),
# поэтому каждый DDL держим отдельно и выполняем по череди.
STATEMENTS: list[str] = [
    ...
    """,
    "CREATE INDEX IF NOT EXISTS idx_ml_short_signals_ts ON ml_short_signals(signal_ts DESC)",
    "CREATE INDEX IF NOT EXISTS idx_ml_short_signals_symbol ON ml_short_signals(symbol)",
    "CREATE INDEX IF NOT EXISTS idx_ml_short_signals_decision ON ml_short_signals(ml_decision)",
    ...
    """,
    "CREATE INDEX IF NOT EXISTS idx_ml_short_positions_status ON ml_short_positions(status)",
    "CREATE INDEX IF NOT EXISTS idx_ml_short_positions_symbol ON ml_short_positions(symbol)",
    "CREATE INDEX IF NOT EXISTS idx_ml_short_positions_entry_ts ON ml_short_positions(entry_ts DESC)",
